 ...
 *
 * FRAME HEIGHT IN FRAMER
 *   Ticker  — give the frame the height you want the band to be
 *             (e.g. 480–720px, or 70vh). Width 100%.
 *   Pinned  — set the frame's height to FIT. The component builds its own
...
const notTicker = (p) => p.mode === "Pinned"
const notPinned = (p) => p.mode !== "Pinned"
...
addPropertyControls(CurvedCardMarquee, {
    cards: {
        ...
        control: {
            ...
            controls: {
                ...
                avatar: { type: ControlType.ResponsiveImage, title: "Avatar" },
    ...
    mode: {
        ...
        title: "Mode",
        options: ["Ticker", "Pinned"],
        optionTitles: ["Ticker", "Pinned section"],
    ...
    pinTravel: {
        ...
        title: "Travels",
        options: ["Loop", "Deck"],
        optionTitles: ["Infinite", "Whole deck"],
        displaySegmentedControl: true,
        defaultValue: "Loop",
        hidden: notPinned,
    },
    pinScroll: {
        ...
        step: 0.25,
        unit: "×vh",
        hidden: (p) => notPinned(p) || p.pinTravel === "Deck",
    },
    pinLoops: {
        type: ControlType.Number,
        title: "Loops",
    ...
    dragRange: {
        ...
        step: 25,
        unit: "px",
        hidden: (p) => notPinned(p) || !p.dragToScroll,
    },
    dragReturn: {
        type: ControlType.Boolean,
        title: "Settle back",
    ...
    curve: {
        type: ControlType.Enum,
        title: "Curve",
        options: ["Arc", "Valley", "Wave", "Tilt", "Cross", "Flat"],
        defaultValue: "Arc",
    },
    curveAmount: {
        type: ControlType.Number,
        ...
        step: 1,
        unit: "px",
        hidden: (p) => p.curve === "Flat" || p.curve === "Cross",
    },
    crossReach: {
        type: ControlType.Number,
        title: "Cross reach",
    ...
    rowSpacing: {
        ...
        max: 160,
        step: 1,
        hidden: (p) => p.rowCount < 2 || p.curve === "Cross",
    },
    rowOffset: {
        type: ControlType.Number,
        title: "Row shuffle",
        ...
        step: 1,
        hidden: (p) =>
            p.rowCount < 2 || (p.mode === "Pinned" && p.pinTravel === "Deck"),
    },
    invertRow2: {
        type: ControlType.Boolean,
        title: "Opposite dir.",
        defaultValue: true,
        hidden: (p) => p.rowCount < 2,
    },
    ...
    sizing: {
        ...
        title: "Card size",
        options: ["Fit", "Fixed"],
        optionTitles: ["Fit viewport", "Fixed px"],
        displaySegmentedControl: true,
        defaultValue: "Fit",
    },
    cardsPerView: {
    ...
    theme: {
        type: ControlType.Enum,
        title: "Theme",
        options: ["Emerald", "Violet", "Amber", "Ice", "Mono", "Custom"],
    ...
    cardBorder: {
        type: ControlType.Color,
        title: "Border",
        defaultValue: "rgba(255,255,255,.12)",
        hidden: (p) => p.theme !== "Custom",
    },
    accentColor: {
        type: ControlType.Color,
