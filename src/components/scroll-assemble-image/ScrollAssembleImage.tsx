...
export default function ScrollAssembleImage(props) {
    ...
    // Framer's Image control returns a string in some versions and a
    ...
    // On the Framer canvas there is no scroll, so show the assembled state.
    // Elsewhere, sync once on mount in case the page loads already scrolled.
    useEffect(() => {
...
// Kept for Framer's canvas defaults; the component also destructures these.
ScrollAssembleImage.defaultProps = DEFAULTS

const isScatter = (p) => p.preset !== "scatter"
const isDepth = (p) => p.preset !== "depth"
const isSpiral = (p) => p.preset !== "spiral"
const usesSpread = (p) => p.preset === "scatter" || p.preset === "iris"
const usesRotation = (p) => p.preset === "glitch"

addPropertyControls(ScrollAssembleImage, {
    image: {
    ...
    order: {
        type: ControlType.Enum,
        title: "Order",
        description: "Which tiles land first. Auto follows the style.",
    ...
    intensity: {
        ...
        title: "Intensity",
        description: "Master multiplier for distance, spin and depth.",
    ...
    imageWidth: {
        type: ControlType.Number,
        title: "Width",
        defaultValue: DEFAULTS.imageWidth,
        min: 100,
        max: 3000,
        step: 10,
        unit: "px",
    ...
    imageHeight: {
        type: ControlType.Number,
        title: "Height",
        defaultValue: DEFAULTS.imageHeight,
        min: 100,
        max: 3000,
        step: 10,
        unit: "px",
    ...
    gap: {
        type: ControlType.Number,
        title: "Gap",
        description: "0 keeps the image seamless; above 0 splits it into cards.",
    ...
    scrollDistance: {
        type: ControlType.Number,
        title: "Scroll",
        description: "Length of the pinned scroll, in screen heights.",
        defaultValue: DEFAULTS.scrollDistance,
        min: 25,
        max: 400,
        step: 5,
        unit: "vh",
    ...
    smoothing: {
        type: ControlType.Number,
        title: "Scrub",
        description: "0 = locked to scroll. Higher = softer catch-up.",
        defaultValue: DEFAULTS.smoothing,
        min: 0,
        max: 3,
        step: 0.1,
        displayStepper: false,
    ...
    easePower: {
        type: ControlType.Number,
        title: "Ease",
        description: "2 matches GSAP power2.out.",
        defaultValue: DEFAULTS.easePower,
        min: 1,
        max: 5,
        step: 1,
        displayStepper: true,
    ...
    spread: {
        type: ControlType.Number,
        title: "Travel",
        description: "How far tiles start from home.",
    ...
    scatterX: {
        type: ControlType.Number,
        title: "Spread X",
        defaultValue: DEFAULTS.scatterX,
        min: 0,
        max: 400,
        step: 5,
        unit: "vw",
    ...
    scatterY: {
        type: ControlType.Number,
        title: "Spread Y",
        defaultValue: DEFAULTS.scatterY,
        min: 0,
        max: 400,
        step: 5,
        unit: "vh",
    ...
    perspective: {
        type: ControlType.Number,
        title: "Perspective",
        defaultValue: DEFAULTS.perspective,
        min: 300,
        max: 4000,
        step: 50,
        unit: "px",
    ...
    scaleMin: {
        type: ControlType.Number,
        title: "Scale Min",
        defaultValue: DEFAULTS.scaleMin,
        min: 0,
        max: 2,
        step: 0.05,
        displayStepper: false,
    ...
    scaleRange: {
        type: ControlType.Number,
        title: "Scale Vary",
        defaultValue: DEFAULTS.scaleRange,
        min: 0,
        max: 2,
        step: 0.05,
        displayStepper: false,
    ...
    blurChance: {
        type: ControlType.Number,
        title: "Blur Odds",
        defaultValue: DEFAULTS.blurChance,
        min: 0,
        max: 1,
        step: 0.05,
        displayStepper: false,
    ...
    opacityRange: {
        type: ControlType.Number,
        title: "Opacity Vary",
        defaultValue: DEFAULTS.opacityRange,
        min: 0,
        max: 1,
        step: 0.05,
        displayStepper: false,
    ...
    showSwitcher: {
        ...
        title: "Switcher",
        description:
            "Lets visitors change the style on the page. Picking one replays the assembly.",
        defaultValue: DEFAULTS.showSwitcher,
    },
    switcherItems: {
        type: ControlType.Array,
        title: "Buttons",
        defaultValue: DEFAULTS.switcherItems,
        control: {
            type: ControlType.Enum,
            options: STYLE_KEYS,
            optionTitles: STYLE_KEYS.map((k) => STYLE_TITLES[k]),
        },
    ...
    switcherPosition: {
        type: ControlType.Enum,
        title: "Place",
        defaultValue: DEFAULTS.switcherPosition,
    ...
    switcherAccent: {
        type: ControlType.Color,
        title: "Active",
        defaultValue: DEFAULTS.switcherAccent,
        hidden: (p) => !p.showSwitcher,
    },
    switcherTint: {
        type: ControlType.Color,
        title: "Bar",
        defaultValue: DEFAULTS.switcherTint,
        hidden: (p) => !p.showSwitcher,
    },
    previewDuration: {
        type: ControlType.Number,
        title: "Replay",
        description: "Seconds the one-shot preview takes after a click.",
        defaultValue: DEFAULTS.previewDuration,
        min: 0.4,
        max: 5,
        step: 0.1,
        displayStepper: false,
    ...
    seed: {
        type: ControlType.Number,
        title: "Seed",
        description: "Change to reshuffle the scatter.",
