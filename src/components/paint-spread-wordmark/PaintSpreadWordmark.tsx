...
addPropertyControls(PaintSpreadWordmark, {
    // ---- type ----
    text: { type: ControlType.String, title: "Text", defaultValue: "HERON AI" },
    fontFamily: {
        type: ControlType.String,
        title: "Font",
        defaultValue: "Archivo",
        description: "Family name only, e.g. Archivo",
    },
    fontWeight: {
        type: ControlType.Enum,
        title: "Weight",
        options: [300, 400, 500, 600, 700, 800],
        optionTitles: ["300", "400", "500", "600", "700", "800"],
        defaultValue: 600,
    },
    sizeMode: {
        type: ControlType.Enum,
    ...
    fitWidth: {
        ...
        unit: "%",
        defaultValue: 89,
        description: "How much of the frame width the word spans",
        hidden: (p: any) => p.sizeMode === "fixed",
    },
    align: {
        type: ControlType.Enum,
    ...
    loadGoogleFont: {
        ...
        title: "Google font",
        defaultValue: true,
        description: "Off if the family is already loaded in your project",
    },

    // ---- colour ----
    background: { type: ControlType.Color, title: "Ground", defaultValue: "#EFEDE6" },
    lineColor: { type: ControlType.Color, title: "Blueprint", defaultValue: "#2A2A26" },
    paintColor: { type: ControlType.Color, title: "Paint", defaultValue: "#1E1E1B" },
    wetColor: { type: ControlType.Color, title: "Wet edge", defaultValue: "#B6B3A8" },
    accent: { type: ControlType.Color, title: "Cursor", defaultValue: "#E8471C" },

    // ---- drafting layer ----
    showMarks: { type: ControlType.Boolean, title: "Crop marks", defaultValue: true },
    showRuler: { type: ControlType.Boolean, title: "Ruler", defaultValue: true },
    outlineWidth: {
        type: ControlType.Number,
        title: "Outline",
        min: 0,
    ...
    inkStyle: {
        type: ControlType.Enum,
        title: "Ink",
        options: ["bleed", "flood", "dry", "spray", "scribble"],
        optionTitles: ["Wet bleed", "Flood", "Dry brush", "Spray", "Scribble"],
        defaultValue: "bleed",
        description: "How each mark is laid down. Switching restyles marks already on the page",
    },
    brush: {
        type: ControlType.Number,
        title: "Brush",
    ...
    flow: {
        ...
        step: 1,
        defaultValue: 58,
        description: "How far a mark bleeds past where it landed",
    },
    dry: {
        type: ControlType.Number,
        title: "Dry",
        ...
        step: 1,
        defaultValue: 26,
        description: "How soon ink starts to go. 0 keeps every mark",
    },
    rate: {
        type: ControlType.Number,
        title: "Rate",
        ...
        step: 1,
        defaultValue: 34,
        description: "How fast it goes once it starts",
    },
    smoothing: {
        type: ControlType.Number,
        title: "Smoothing",
        ...
        step: 1,
        defaultValue: 45,
        description: "How much the brush tip lags and smooths the pointer",
    },
    wetZone: {
        type: ControlType.Number,
        title: "Wet zone",
        ...
        step: 0.1,
        defaultValue: 2.6,
        description: "Radius around the cursor that never dries, in brush widths",
    },
    edgeWobble: {
        type: ControlType.Number,
        title: "Edge",
        ...
        step: 1,
        defaultValue: 45,
        description: "0 is a clean pool, 100 is a ragged torn edge",
    },
    dripChance: {
        type: ControlType.Number,
        title: "Drips",
    ...
    stainOpacity: {
        ...
        step: 1,
        defaultValue: 34,
        description: "The pale residue left behind as ink dries",
    },
    ...
    trigger: {
        ...
        title: "Paints on",
        options: ["hover", "press"],
        optionTitles: ["Hover", "Press"],
        displaySegmentedControl: true,
        defaultValue: "hover",
    },
    showCursor: { type: ControlType.Boolean, title: "Cursor mark", defaultValue: true },
    cursorSize: {
        type: ControlType.Number,
        title: "Mark size",
        min: 2,
        ...
        unit: "px",
        defaultValue: 9,
        hidden: (p: any) => !p.showCursor,
    },
    seedOnLoad: {
        type: ControlType.Boolean,
        title: "Pre-inked",
        defaultValue: true,
        description: "Start with a stroke already laid down",
    },
    autoDemo: {
        type: ControlType.Boolean,
        title: "Self-paint",
        defaultValue: false,
        description: "Traces the word on its own when no pointer is over it",
    },
    demoSpeed: {
        type: ControlType.Number,
        title: "Demo speed",
    ...
    quality: {
        ...
        defaultValue: "high",
        description: "Lower caps pixel density and live marks on heavy pages",
    },
})
